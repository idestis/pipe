...
| `PIPE_EXPERIMENTAL_UNSAFE_VARS` | unset | Disable the vars contract — allow override sources to introduce keys not declared in `vars` (see [Variables](/guides/variables/)) |
